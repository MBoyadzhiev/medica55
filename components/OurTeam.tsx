...
const cards = [
  ...
  {
    title: "Д-р Росица Стойчева",
    src: "/stoicheva.jpg",
    ctaText: "See More",
    ctaLink: "#",
    content: () => (
      <p>
        Специалист по детска ендокринология и болести на обмяната. Завършва
        Медицински университет Варна през 2006 г., придобива специалност през
        2017 г. и е докторант по хранене на тема дигитална хранителна
        интервенция при деца с тип 1 захарен диабет. Обслужва пациенти на
              ...
              <div>
                <div className="flex justify-between items-start p-4">
                  <div className="">
                    <motion.h3
                      ...
                      className="font-bold text-black dark:text-black"
                    >
                      {active.title}
                    </motion.h3>
                  </div>
                ...
                <div className="pt-4 relative px-4">
                  <motion.div
                    ...
                    animate={{ opacity: 1 }}
                    exit={{ opacity: 0 }}
                    className="text-neutral-800 text-xs md:text-sm lg:text-base h-40 md:h-fit pb-10 flex flex-col items-start gap-4 overflow-auto dark:text-neutral-800 [mask:linear-gradient(to_bottom,white,white,transparent)] [scrollbar-width:none] [-ms-overflow-style:none] [-webkit-overflow-scrolling:touch]"
                  >
