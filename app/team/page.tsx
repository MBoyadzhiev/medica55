...
export const metadata: Metadata = {
  ...
  description:
    "Запознайте се с екипа на Медика 55 - водещи специалисти в детска медицина: д-р Миглена Георгиева, д-р Ния Рашева, д-р Мартина Гълъбова, д-р Росица Стойчева, д-р Мартин Бояджиев.",
  alternates: {
            ...
            __html: JSON.stringify({
              ...
              "@graph": [
                ...
                },
                {
                  ...
                  affiliation: "Медика 55",
                  image: "https://medica55.bg/stoicheva.jpg",
                },
                {
                  "@type": "Person",
