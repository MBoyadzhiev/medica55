...
export const metadata: Metadata = {
  title: "Д-р Мартин Бояджиев | Детски ревматолог Варна - Медика 55",
  description:
    "Д-р Мартин Бояджиев - детски ревматолог във Варна с над 12 години опит. Диагностика и лечение на ставни болки, автоимунни заболявания, васкулити при деца. Записване: 0888 123 456.",
  keywords: [
    "д-р мартин бояджиев",
    "детски ревматолог",
    ...
    "бояджиев ревматолог",
    "детска ревматология варна",
    "ставни болки при деца",
    "автоимунни заболявания",
    "васкулити",
    "ревматолог за деца варна",
    "детски лекар ревматолог",
    "педиатрична ревматология",
  ],
  alternates: {
    canonical: "https://medica55.org/team/boyadzhiev",
  },
  openGraph: {
    title: "Д-р Мартин Бояджиев | Детски ревматолог Варна - Медика 55",
    description:
      "Д-р Мартин Бояджиев - детски ревматолог във Варна с над 12 години опит. Диагностика и лечение на ставни болки, автоимунни заболявания, васкулити при деца.",
    url: "https://medica55.bg/team/boyadzhiev",
    siteName: "Медика 55",
    images: [
      {
        url: "https://medica55.org/boyadzhiev.jpg",
        width: 800,
        height: 600,
